  ...
  const generatePredictionMutation = useMutation({
    ...
    onError: (error: any) => {
      ...
      if (error?.message === 'AI_DATA_SHARING_DISABLED') {
        ...
        errorMessage =
          'Smart Predictions are still in development. This feature will be available soon!';
          ...
          <div className='flex items-center gap-4 mb-4'>
            ...
            <div>
              ...
              <p className='text-sm text-muted-foreground'>
                AI-powered suggestions based on your baby's patterns
              </p>
            </div>
          </div>
            ...
            <Card key={prediction.id} className='p-4'>
              <div className='flex items-start justify-between mb-3'>
                ...
                <div className='flex items-center gap-2'>
                  <div
                    className={`w-2 h-2 rounded-full ${getConfidenceColor(prediction.confidence_score)}`}
                  />
              ...
              {prediction.prediction_data && (
                <div className='space-y-2'>
                  ...
                  {prediction.prediction_data.avgInterval && (
                    <p className='text-sm'>
                      <strong>Avg interval:</strong> {prediction.prediction_data.avgInterval} hours
                    </p>
                  )}
                </div>
              )}
