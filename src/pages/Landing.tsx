...
export default function Landing() {
  ...
  const features = [
    {
      ...
      description:
        'Track feeds, diapers, and sleep in just 2 taps. Designed for tired parents at 3 AM.',
    ...
    },
    {
      ...
      description:
        'Get smart nap predictions, pattern detection, and personalized recommendations.',
      color: 'text-primary',
    ...
    },
    {
      ...
      description:
        'Share with your partner, grandparents, or nanny. Everyone stays in sync, instantly.',
  ...
  const testimonials = [
    {
      quote:
        "Finally, a baby tracker that doesn't make me feel more overwhelmed! The 2-tap logging is a lifesaver at 3 AM.",
      author: 'Sarah M.',
    ...
    {
      quote:
        "The AI nap predictions actually work. It learned my baby's patterns in just 3 days and now I can plan my day around naps.",
      author: 'Mike T.',
    ...
    {
      quote:
        "Syncing with my partner changed everything. No more texting 'when did baby last eat?' every handoff.",
      author: 'Jessica L.',
      role: 'Mom of twins',
      rating: 5,
    },
      ...
      <div className='max-w-6xl mx-auto px-4 pt-8 pb-16'>
        ...
        <div className='text-center max-w-3xl mx-auto mb-16'>
          ...
          <p className='text-lg md:text-xl text-muted-foreground mb-8 animate-fade-in max-w-2xl mx-auto'>
            Track baby care in 2 taps. Get AI predictions for naps and feeds. Sync instantly with
            your partner. Built for 3 AM.
          </p>
        ...
        <div className='mb-20'>
          ...
          <p className='text-center text-lg text-muted-foreground mb-12 max-w-2xl mx-auto'>
            We know you're tired. We know you're overwhelmed. That's why we made this ridiculously
            simple.
          </p>
            ...
            {testimonials.map((testimonial, index) => (
              <Card key={index} variant='elevated' className='hover:shadow-xl transition-shadow'>
                <CardContent className='p-6'>
                  ...
                  <p className='text-sm leading-relaxed mb-4 italic'>"{testimonial.quote}"</p>
          ...
          <Card className='border-2 border-primary/20 bg-gradient-to-br from-background to-primary/5'>
            <CardContent className='p-8 md:p-12 text-center'>
              ...
              <p className='text-lg text-muted-foreground max-w-2xl mx-auto mb-6'>
                No ads. No tracking. No data mining. Your baby's information is encrypted and only
                accessible by caregivers you explicitly invite.
              </p>
        ...
        <div className='text-center max-w-2xl mx-auto'>
          <h2 className='text-3xl md:text-4xl font-bold mb-6'>Ready to simplify baby tracking?</h2>
