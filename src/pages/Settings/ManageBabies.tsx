  ...
  return (
    <div className='min-h-screen bg-surface pb-20'>
      <div className='max-w-2xl mx-auto p-4 space-y-4'>
              ...
              <CardContent className='p-4'>
                <div className='flex items-center gap-3'>
                  ...
                  <div className='flex gap-2'>
                    <Button variant='ghost' size='icon' onClick={() => handleEdit(baby)}>
                      <Pencil className='h-4 w-4' />
                    </Button>
                    <Button variant='ghost' size='icon' onClick={() => setDeletingBabyId(baby.id)}>
        ...
        <Button className='w-full' onClick={() => navigate('/onboarding-simple')}>
      ...
      <AlertDialog open={!!deletingBabyId} onOpenChange={() => setDeletingBabyId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete all data for this baby, including events. This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
