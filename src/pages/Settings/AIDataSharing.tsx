          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <CardDescription className="text-sm leading-relaxed">
                Baby logs and optional audio may be sent to our AI provider (Google Gemini) to generate predictions, cry analysis, and personalized advice. Your data is never sold or used for advertising.
              </CardDescription>
            </div>
            <Switch
              checked={enabled}
      ...
      <div className="space-y-4 mb-6">
        <Card>
          ...
          <CardContent className="text-sm text-muted-foreground space-y-2">
            ...
            <p className="mt-3 text-xs">Data is sent securely and processed in real-time. We do not store your data on AI provider servers.</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="text-sm text-muted-foreground space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Smart Predictions:</strong> Next nap/feed times based on patterns</li>
              <li><strong>Cry Insights:</strong> Possible causes and suggestions</li>
              <li><strong>AI Assistant:</strong> Answers to parenting questions</li>
            </ul>
          </CardContent>
        </Card>
            ...
            <div className="flex gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Smart Predictions, Cry Analysis, and AI Assistant will not work until you enable AI data sharing.
                </p>
              </div>
            </div>
          </CardContent>
