...
import {
  ...
  TasteOfDoctorReport,
  TasteOfAIInsights,
  TasteOfCaregiverSync,
} from '@/components/TasteOfPro';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
            ...
            <div className='pt-2'>
              <p className='text-sm text-muted-foreground mb-3'>
                ...
                <span className='text-xs'>
                  Also available: {paywallVariant.pricing.monthly} •{' '}
                  {paywallVariant.pricing.lifetime}
                </span>
              </p>
          ...
          <CardContent className='space-y-4'>
            <div className='flex items-center justify-between'>
              <div className='space-y-0.5'>
                <Label htmlFor='caregiver-mode' className='text-base'>
                  Caregiver Mode
                </Label>
                ...
                <div className='flex items-start gap-2'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className='text-xs leading-relaxed mt-1'>
                      Nestling is not a medical device. Always consult your pediatrician or
                      healthcare provider for medical advice, diagnosis, or treatment. AI features
                      provide general information only and should not replace professional medical
                      judgment.
                    </p>
                  </div>
                </div>
