...
export const NapPredictionCard = memo(
  ({ prediction, babyId, onFeedbackSubmitted }: NapPredictionCardProps) => {
    const now = new Date();
                ...
                <PopoverContent className='w-80'>
                  <div className='space-y-2'>
                    ...
                    <p className='text-xs text-muted-foreground'>
                      Predictions improve as you log more sleep events. Your feedback helps us learn
                      your baby's unique patterns.
                    </p>
                  </div>
                </PopoverContent>
              </Popover>
