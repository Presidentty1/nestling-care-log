...
export function SubscriptionBanner() {
  ...
  return (
    <Card
      className={`mx-4 mb-4 border-primary/20 ${
        isTrialEnding
      ...
      <div className='p-4'>
        <div className='flex items-start justify-between'>
          <div className='flex items-start gap-3 flex-1'>
            <div
              className={`p-2 rounded-full ${isTrialEnding ? 'bg-warning/20' : 'bg-primary/20'}`}
            >
              {isTrialEnding ? (
            ...
            <div className='flex-1'>
              ...
              <Button size='sm' onClick={handleUpgrade} className='mr-2'>
