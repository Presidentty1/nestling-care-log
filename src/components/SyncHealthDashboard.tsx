      ...
      <CardHeader>
        <div className='flex items-center justify-between'>
          <div>
            ...
            <CardDescription>{isOnline ? 'Connected to cloud' : 'Working offline'}</CardDescription>
          </div>
          ...
          {pendingCount > 0 && (
            <div className='space-y-1'>
              <div className='flex items-center justify-between text-sm'>
                ...
                <span className='font-medium'>{isSyncing ? 'Syncing...' : 'Pending'}</span>
              </div>
        ...
        {pendingCount > 0 && (
          <div className='space-y-2'>
            ...
            <div className='grid grid-cols-2 gap-2'>
              {Object.entries(pendingByType).map(
                ([type, count]) =>
                  count > 0 && (
                    <div
                      key={type}
