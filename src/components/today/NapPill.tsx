      ...
      <PopoverContent className='w-80' align='start'>
        <div className='space-y-4'>
          <div>
            ...
            <p className='text-caption text-muted-foreground'>{prediction.reason}</p>
            ...
            {learningMetrics && learningMetrics.daysLogged > 0 && (
              <div className='mt-3 p-2 bg-muted/50 rounded text-xs'>
                ...
                <p className='text-muted-foreground'>
                  Tuned from {learningMetrics.daysLogged} day
                  {learningMetrics.daysLogged !== 1 ? 's' : ''} of logs, based on{' '}
                  {learningMetrics.napCount} nap{learningMetrics.napCount !== 1 ? 's' : ''}
                </p>
