      ...
      <DialogContent className='max-w-2xl max-h-[80vh] overflow-y-auto'>
        ...
        <div className='space-y-4'>
          <p className='text-sm text-muted-foreground'>
            Some data was modified on another device while you were offline. Please choose how to
          ...
          <div className='flex justify-end pt-4 border-t'>
            <Button onClick={onClose}>{conflicts.length === 0 ? 'Close' : 'Resolve Later'}</Button>
          </div>
        </div>
      </DialogContent>
    </Dialog>
