                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <div className="bg-muted rounded-lg p-3">
                      <p className="text-sm">My baby is 8 weeks old and wakes every 2 hours. Is this normal?</p>
                    </div>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <div className="bg-primary/10 rounded-lg p-3">
                      <p className="text-sm">Yes, this is completely normal for an 8-week-old. Newborns typically need to feed every 2-3 hours around the clock...</p>
                    </div>
                  </div>
                </div>
              </div>
