...
# Calculate path: script is in ios/scripts, project is in ios/Nestling
script_dir = File.dirname(File.expand_path(__FILE__))
project_root = File.expand_path(File.join(script_dir, '..', '..'))
project_path = File.join(project_root, 'ios', 'Nestling', 'Nestling.xcodeproj')
...
sources_build_phase = nestling_target.source_build_phase
