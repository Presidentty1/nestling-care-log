# Terms of Service Template for Nuzzle
...
By accessing or using Nuzzle ("the Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these terms, you may not access the Service.
...
You must be at least 18 years old to use Nuzzle. By using the Service, you represent that you are at least 18 years old and have the legal capacity to enter into these Terms.
...
**Legal**: legal@nuzzle.app
**Website**: https://nuzzle.app/terms
...
These Terms constitute the entire agreement between you and Nuzzle regarding the Service.
